                ...
                <div className="mx-auto max-w-3xl">
                    ...
                    <div className="mt-8">
                        <ul className="space-y-4">
                            {cart.map((item, i) => <li key={i} className="flex items-center gap-4">
                                <img
                                    src={item.image}
                                ...
                                <div>
                                    <h3 className="text-lg text-green-900">{item?.productName}</h3>

                                    <dl className="mt-0.5 space-y-px text-[14px] text-gray-600">
                                        <div>
                                            <dt className="inline text-md">Size:</dt>
                                            <dd className="inline text-md">XXS</dd>
                                        </div>

                                        <div>
                                            <dt className="inline text-md">Price: </dt>
                                            <dd className="inline text-md"> $ {item?.price}</dd>
                                        </div>
                                    </dl>
                                </div>
                        ...
                        <div className="mt-8 flex justify-end border-t border-gray-100 pt-8">
                            <div className="w-screen max-w-lg space-y-4">
                                ...
                                <div className="flex justify-end">
                                    <span
                                        className="inline-flex items-center justify-center rounded-full bg-indigo-100 px-2.5 py-0.5 text-green-700"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
