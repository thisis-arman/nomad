...
const Checkout = () => {
    ...
    const handleCheckout = (e:Event) => {
        ...
        console.log({name,contactNo,email,company,address});
        ...
        <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            >
                <div
                    ...
                    className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#195834] to-[#056f28] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
                />
            </div>
            <div className="mx-auto max-w-2xl text-center">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Checkout</h2>
                <p className="mt-2 text-lg leading-8 text-gray-600">
                    Please Checkout with your valid information.
                </p>
            </div>
            <form onSubmit={(e) => handleCheckout(e)} action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
